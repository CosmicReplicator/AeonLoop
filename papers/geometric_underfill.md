...
| **Solar-system** $$\dot G/G$$ **bound** | <span style="display:inline-block;">$$\displaystyle\Bigl|\frac{\dot G}{G}\Bigr|<10^{-14}\,\text{yr}^{-1}$$</span><br>(under-fill nearly flat at AU) | Messenger, Cassini, LLR data already archived |
