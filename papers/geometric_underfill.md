...
| **Solar-system** $$\dot{G}/G$$ **bound** | <span style="white-space: nowrap;">$$\displaystyle\left|\frac{\dot{G}}{G}\right| < 10^{-14}\,\text{yr}^{-1}$$ (under-fill nearly flat at AU)</span> | Messenger, Cassini, LLR data already archived |
