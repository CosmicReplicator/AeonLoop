...
<tr>
  <td colspan="3" style="text-align: center; padding-top: 0.5em;">
    <strong>Solar-system</strong> $$\dot{G}/G$$ <strong>bound</strong> – 
    $$\displaystyle\left|\frac{\dot{G}}{G}\right| < 10^{-14}\,\text{yr}^{-1}$$ 
    (under-fill nearly flat at AU)
    <br>
    Messenger, Cassini, LLR data already archived
  </td>
</tr>
